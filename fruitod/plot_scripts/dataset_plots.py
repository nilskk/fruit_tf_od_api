...
if __name__ == '__main__':
    ...
    plt.figure()
    ax = sns.scatterplot(data=object_dataframe, x='box_width', y='box_height', hue='class', style='size')
    ...
    plt.figure()
    sns.scatterplot(data=file_dataframe, x='weight', y='objects', hue='class')
